...
def _pedido(e: Escena, ids: list[list[str]], reparto: dict, locaciones: dict,
    ...
    return (
        ...
        "- LOS PERSONAJES ESTÁN PARADOS O SENTADOS Y QUIETOS, enfrentados, con la BOCA VISIBLE y libre "
        "(nada tapándola). Nadie caminando, nadie en movimiento, nadie a mitad de un gesto: si el clip "
        "vuelve a esta pose cada 5 segundos, tiene que ser una pose de reposo.\n"
        ...
        "- Movimiento chico y que vuelve: un gesto de la mano, un cambio de peso, una mirada. Nada de "
        "entrar o salir de cuadro, nada de cambiar de lugar.\n\n"
