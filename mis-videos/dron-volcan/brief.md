# EL DRON DEL VOLCÁN — estructura por tramos
...
|---|---|---|---|---|
| S01 | 0.0–3.0 | 3.0 s | PD | HOOK. Las antiparras se encienden de naranja: algo volvió a emitir ahí abajo. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S02 | 3.0–5.5 | 2.5 s | PGE | PROMESA. Dónde estamos y qué está en juego: una persona diminuta contra un cráter humeando, y el dron entrando. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S03 | 5.5–9.7 | 4.2 s | PG | BARRA DE PROGRESO. El descenso con número: la pared cayendo a toda velocidad, el contador en post. |
| S04 | 9.7–14.0 | 4.3 s | PD | TENSIÓN POR AUSENCIA. Entra al gas y no hay nada. Cambio de régimen: el sonido se apaga, la luz se apaga. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S05 | 14.0–19.5 | 5.5 s | PG | ESCALERA 1. Del gas sale una forma: un brillo metálico en una cornisa. Todavía no se sabe qué es. |
| S06 | 19.5–25.5 | 6.0 s | PGE | ESCALERA 2 · ESCALA. El plano vertical juega: la cornisa diminuta contra la pared entera y el lago de lava abajo. |
| S07 | 25.5–32.0 | 6.5 s | PD | LA REVELACIÓN, al final del tramo. Es el dron perdido: quemado, torcido — y con la cámara todavía grabando. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S08 | 32.0–38.1 | 6.1 s | PGE | GIRO, a la mitad exacta. El lago revienta: entra una luz nueva de abajo y un rugido que no estaba. Ahora hay reloj. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S09 | 38.1–43.3 | 5.2 s | PD | CONTACTO físico. El gancho baja y agarra el chasis quemado, con las brasas subiendo alrededor. |
| S10 | 43.3–49.3 | 6.0 s | PP | EL DETALLE IMPOSIBLE, sostenido para que se lea: colgado del cable, su cámara gira sola y queda mirando al lente. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S11 | 49.3–54.9 | 5.6 s | PD | EL PAGO. Vuelta al tamaño del gancho: las antiparras naranjas, el dron quemado ya en la mano. La voz suelta el dato que reordena todo. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S12 | 54.9–60.0 | 5.1 s | PGE | CIERRE EN BUCLE. La misma boca del cráter del segundo 3 — pero la columna es el doble de alta. Empalma con el arranque y corta a negro. |
