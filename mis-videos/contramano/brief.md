# CONTRAMANO — estructura por tramos
...
|---|---|---|---|---|
| S01 | 0.0–3.0 | 3.0 s | PP | HOOK. Un faro que crece en el visor y una voz que grita. Cero contexto. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S02 | 3.0–5.5 | 2.5 s | PGE | PROMESA. Dónde está: un túnel de tren, y él entrando igual. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S03 | 5.5–9.5 | 4.0 s | PD | BARRA DE PROGRESO. El diagrama de vías: dos puntos que se acercan. |
| S04 | 9.5–14.0 | 4.5 s | PG | TENSIÓN POR AUSENCIA. El túnel vacío y negro por delante: no hay salida. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S05 | 14.0–20.0 | 6.0 s | PGE | ESCALERA 1 · arranca la toma continua: el rumbo se vuelve luz. |
| S06 | 20.0–26.0 | 6.0 s | PGE | ESCALERA 2 · MISMA TOMA: la luz se vuelve un tren. |
| S07 | 26.0–31.5 | 5.5 s | PGE | LA REVELACIÓN · MISMA TOMA: hay un nicho de servicio en la pared. |
| S08 | 31.5–37.5 | 6.0 s | PD | INTERRUPCIÓN DE PATRÓN: se corta el estruendo y estamos en silencio, mirando una pantalla. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S09 | 37.5–42.5 | 5.0 s | PP | CONTACTO · arranca la segunda toma continua: la maniobra. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S10 | 42.5–48.5 | 6.0 s | PG | LO IMPOSIBLE · MISMA TOMA: entra al nicho y el tren pasa a centímetros. |
| S11 | 48.5–54.0 | 5.5 s | PP | EL PAGO. Quieto por primera vez en un minuto. Y contesta. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S12 | 54.0–59.5 | 5.5 s | PGE | CIERRE EN BUCLE. Otra luz, del otro lado. No terminó. |
...
- ⚠ S12 es PGE y el tramo PAGO sugiere PP/PD
- ⚠ el tramo GIRO pide texto en pantalla y ningún plano lo trae: agregá `texto` al plano (Opcional: si el giro necesita una palabra para leerse, va acá y son dos o tres.)
- ⚠ el tramo BUCLE (54.5-60 s) tiene 0 plano(s) y pide al menos 1
