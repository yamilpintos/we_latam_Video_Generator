# PROFUNDIDAD — estructura por tramos
...
|---|---|---|---|---|
| S01 | 0.0–3.0 | 3.0 s | PP | HOOK. Bucle abierto: la voz promete algo y no lo entrega. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S02 | 3.0–5.5 | 2.5 s | PGE | Descenso. El corte rápido mantiene el pulso alto. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S03 | 5.5–9.5 | 4.0 s | PD | BARRA DE PROGRESO. El número que sube le da al ojo algo que seguir. |
| S04 | 9.5–14.0 | 4.5 s | PG | TENSIÓN POR AUSENCIA. Cuatro segundos de nada antes del hallazgo. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S05 | 14.0–20.0 | 6.0 s | PGE | ESCALERA 1: de la nada a algo. |
| S06 | 20.0–26.0 | 6.0 s | PGE | ESCALERA 2: la escala. Que sea vertical juega a favor acá. |
| S07 | 26.0–32.0 | 6.0 s | PGE | LA REVELACIÓN. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S08 | 32.0–38.0 | 6.0 s | PD | INTERRUPCIÓN DE PATRÓN, justo a la mitad, donde cae la retención. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S09 | 38.0–43.0 | 5.0 s | PD | CONTACTO. El golpe desde adentro es el gancho del tramo. |
| S10 | 43.0–49.0 | 6.0 s | PG | LO IMPOSIBLE. Seco por dentro es el detalle que lo vuelve inexplicable. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S11 | 49.0–54.5 | 5.5 s | PP | EL PAGO. La voz suelta el dato que reordena todo. |
...
| plano | en línea | corta | tipo | función |
|---|---|---|---|---|
| S12 | 54.5–60.0 | 5.5 s | PGE | CIERRE EN BUCLE. No cerramos la historia: abrimos una más grande. |
